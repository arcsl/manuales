<img src="./imagenes/arcLogo.png" alt="LogoARC" style="position: absolute; top: 0; right: 0; width: 50px;"/>

# Siemens Logo! 8

# Manual de Uso de la Pantalla

## Introducción

El PLC Logo! 8 de Siemens es un controlador lógico programable compacto y versátil que se utiliza en diversas aplicaciones de automatización. Este dispositivo es conocido por su facilidad de uso, flexibilidad y eficiencia. Dada la versatilidad del equipo y la infinidad de formas de programar y personalizar, este manual está orientado específicamente a los equipos programados por **ARC S.L.**, proporcionando una guía detallada sobre cómo navegar por la pantalla, ajustar consignas y horarios, gestionar alarmas y configurar el sistema para satisfacer sus necesidades específicas.
...
6. Una vez seleccionado, presionar **OK** para entrar a modificar el valor. **ATENCION** un valor con decimales, p. ej consigna de depósito 60.0ºC, se mostrará sin el punto decimal mientras se está modificando, en este ejemplo se mostrará `00600`.
